...
// Based on http://www.khronos.org/registry/webgl/specs/latest/
extern class WebGLRenderingContext {/*
    ...
    public function activeTexture(texture: Int);
    public function attachShader(WebGLProgram? program, WebGLShader? shader);
